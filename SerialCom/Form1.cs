...
namespace SerialCom
{
    public partial class MainForm : Form
    {
        ...
        private static readonly String[] tempPorts = { "COM1", "COM2", "COM3", "COM4" };
        ...
        private void InitFormPage()
        {
            ...
            //临时串口集合            
            if (null == serialPorts || serialPorts.Length <= 0)
            {
        ...
        private void buttonOpenCloseCom_Click(object sender, EventArgs e)
        {
            if (!serialPort.IsOpen)//串口处于关闭状态
            {
                try
                {
                    ...
                    string strSerialName = comboBoxCom.SelectedText.ToString();
                    string strBaudRate = comboBoxBaudRate.SelectedText.ToString();
                    string strDataBit = comboBoxDataBit.SelectedText.ToString();
                    string strCheckBit = comboBoxCheckBit.SelectedText.ToString();
                    string strStopBit = comboBoxStopBit.SelectedText.ToString();
        ...
        private void buttonSendData_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                foreach (char letter in values)
                {
                    string hexIutput = String.Format("{0:X}", Convert.ToInt32(letter));
